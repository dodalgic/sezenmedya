...
<html prefix="og: http://ogp.me/ns#" lang="tr-TR" dir="ltr">
	<head>
		...
		<meta property="og:url" content="https://dodalgic.github.io/sezenmedya/imsearch.php" />
		<meta property="og:title" content="Arama" />
		<meta property="og:site_name" content="Sezen Medya – Canlı TV, Radyo ve Hesaplama Araçları" />
		<meta property="og:image" content="https://dodalgic.github.io/sezenmedya/favImage.png" />
		<meta property="og:image:type" content="image/png">
		<meta property="og:image:width" content="512">
		<meta property="og:image:height" content="512">
		<meta property="og:image" content="https://dodalgic.github.io/sezenmedya/favImage_small.png" />
		<meta property="og:image:type" content="image/png">
		...
		<link rel="stylesheet" href="pcss/imsearch.css?2026-2-2-0-639168193718583597" media="screen,print" />
		...
		<link rel="icon" href="favicon.png?2026-2-2-0-639168193718473654" type="image/png" />
...
<ul class="menu-mobile-animated hidden">
	<li class="imMnMnFirst imPage" data-link-paths=",/sezenmedya/index.html,/sezenmedya/">
...
$(function () {$('#imStickyBar_imMenuObject_01_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_01_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_01_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_13_tab0" style="opacity: 1; " role="tabpanel" tabindex="0">
		<div class="text-inner">
			<div class="fs10lh1-5 cf2"><div data-text-align="start"><span class="cf1">Keşfet</span><br></div><div data-text-align="start"><br><div data-text-align="start"><span class="cf2">Blog<br></span><br></div></div></div>
		</div>
	</div>
